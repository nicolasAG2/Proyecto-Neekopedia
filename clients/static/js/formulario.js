...
const inputs = document.querySelectorAll('#formulario input'); //Regresa un array con todos los inputs
...
formulario.addEventListener('submit', (e) => {
    ...
    if(campos.usuario && campos.nombre && campos.apellido && campos.correo && campos.telefono && campos.password && terminos.checked){
        formulario.reset();
